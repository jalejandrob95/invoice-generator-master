...
class InvoiceForm extends React.Component {
  ...
  handleCalculateTotal = () => {
    ...
    const taxAmount = parseFloat(subTotal * (this.state.taxRate / 100));
    const discountAmount = parseFloat(
      subTotal * (this.state.discountRate / 100)
    );
        ...
        <Row>
          <Col md={8} lg={9}>
            <Card className="p-4 p-xl-5 my-3 my-xl-4">
              <div className="d-flex flex-row align-items-start justify-content-between mb-3">
                <div class="d-flex flex-column">
                  <div className="d-flex flex-column">
                    <div class="mb-2">
                      <span className="fw-bold">Fecha&nbsp;Actual:&nbsp;</span>
              ...
              <Row className="mb-5">
                <Col>
                  <Form.Label className="fw-bold">Factura a:</Form.Label>
                  <Form.Control
                    placeholder={"nombre de la empresa de destino"}
                    rows={3}
                ...
                <Col>
                  <Form.Label className="fw-bold">Emitida por:</Form.Label>
                  <Form.Control
